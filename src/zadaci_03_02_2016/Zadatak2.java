...
public class Zadatak2 {
	...
	/*
	 * Napisati metodu koja mnozi 2 matrice koje korisnik unese. Metoda treba da koristi sljedeæi header:
	 * public static double[ ][ ] multiplyMatrix(double[ ][ ] a, double[ ][ ] b)
	 * Da bi dvije matrice bile pomnozene, moraju biti istih dimenzija i istog ili kompatibilnog tipa elemenata.
	 * Rezultat mnozenja matrica pohraniti u treæu matricu, matricu c, i ispisati korisniku rezultat.
	 * Napisati test program koji pita korisnika da unese dvije matrice 3 x 3 i ispisuje njihov proizvod.
	 */	
